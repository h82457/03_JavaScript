...
/* object */
// 한번에 값을 여러개 저장할 수 있는 형태

//1) 배열(array): 여러 값이 나열되어 있는 것의 묶음
const numbers = [10, 20, 30];
console.log("numbers : ", numbers, typeof numbers);
console.log("numbers 배열 값 중 0번쨰 : ", numbers[0], typeof numbers[0]);
console.log("numbers 배열 값 중 1번쨰 : ", numbers[1], typeof numbers[1]);
console.log("numbers 배열 값 중 2번쨰 : ", numbers[2], typeof numbers[2]);

// 2) JS object
// 값을 K:V (Map) 형식으로 여러개 저장하는 형태
//  -> {K:V , K:V , K:V} 

// K(key) : 값을 구분하는 이름 (변수명과 비슷한것)

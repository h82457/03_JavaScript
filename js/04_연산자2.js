...
function checkFn3(){
    ...
    /* 백틱(`)을 이용한 문자열 작성하기 */
    // 문자열 전체를 백틱(`)으로 감싼 후 변수, 연산결과 등이 출려고디는 자리에 ${변수명} 또는 ${연산식} 을 작성
...
function login(){
    ...
    const massage = ( id == 'member01' ) && ( pw == 'pass01!' ) ? success : fail;
